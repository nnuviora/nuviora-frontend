...
const AppSidebar = () => {
  ...
  return (
    <Sidebar
      ...
      className={cn(
        "xl2:w-(--sidebar-width) h-[calc(100vh-116px-91px)] w-full group-data-[collapsible=icon]:items-center group-data-[variant=floating]:rounded-2xl md:w-[280px] xl:h-[calc(100vh-129px-24px)]",
      )}
    >
