...
const SignInSchema: ObjectSchema<Omit<entryForm, "passwordConfirm">> =
  object().shape({
...
export const SignInForm = () => {
  const {
    ...
    formState: { errors },
    reset,
  } = useForm<Omit<entryForm, "passwordConfirm">>({
    defaultValues: {
      email: "",
      password: "",
  ...
  const onSubmit: SubmitHandler<Omit<entryForm, "passwordConfirm">> = (
    data,
  ) => {
